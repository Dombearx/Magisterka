...
import argparse
import numpy as np
from new_frams.framsfiles import reader as framsreader
from new_frams.framsfiles import writer as framswriter
...
class FramsticksCLI:
	...
	def __runCommand(self, command, genotypes, result_file_name, saveformat) -> List[str]:
		...
		# Those lines are slow, needs about 0.2 sec to process.
		print("new_frams_time", time.time() - t)
