...
from evolalg.utils.name_propagation import propagate_names
...
def create_experiment():
    ...
    # Steps after new population is created. Executed exacly once per generation.
    ...
    if parsed_args.fit == Fitness.niching:
        niching = UnionStep([
            dissim,
    ...
    # -------------------------------------------------
    # End stages: this will execute exacly once after all generations.
    end_stages = [
        replace_with_hof,
        fitness_end,
