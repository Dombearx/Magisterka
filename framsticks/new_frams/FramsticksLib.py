...
import argparse
import numpy as np
import framsticks.new_frams.frams as frams
...
class FramsticksLib:
	...
	EVALUATION_SETTINGS_FILE = "eval-allcriteria.sim"  # MUST be compatible with the standard-eval expdef
	...
	def __init__(self, frams_path, frams_lib_name, simsettings):
		...
		if simsettings is not None:
			self.EVALUATION_SETTINGS_FILE = simsettings
		frams.Simulator.ximport(self.EVALUATION_SETTINGS_FILE, 4 + 8 + 16)
